...
//MOD CONFIG
inline const std::string NAME = "font-tweaker"; //Name of the mod, used for the required/allowed checks and to check if loaded mod is unique
inline const std::string DISPLAY_NAME = "Font Tweaker"; //Display name in game, used mainly for the imgui context
